...
export const ASANAS = {
  ...
  warrior1: {
    ...
    reasoning: 'A powerful standing pose that channels fierce determination. Warrior I opens the heart centre while grounding through the legs — excellent for building both physical and mental strength.',
    voiceCues: {
  ...
  warrior2: {
    ...
    voiceCues: {
      ...
      breathe: 'Breathe steadily. Hold your ground. Feel the power radiating from your centre.',
  ...
  tree: {
    ...
    voiceCues: {
      enter: 'Shift your weight onto your left foot. Place your right foot on your inner left thigh or calf — never on the knee. Bring your hands to heart centre.',
  ...
  seatedTwist: {
    ...
    voiceCues: {
      ...
      exit: 'Release the twist slowly. Come back to centre. We will do the other side.',
    },
    poseKey: 'seatedTwist',
  },
  ...
  supinetwist: {
    ...
    voiceCues: {
      ...
      exit: 'Bring your knee back to centre. Hug both knees in briefly. Now the other side.',
    },
    poseKey: 'supineTwist',
  },
  ...
  cobra: {
    ...
    reasoning: 'Backbends are heart-openers that combat Kapha heaviness and lethargy. Cobra gently energises the spine and awakens the body, making it ideal for morning routines or low-energy days.',
    voiceCues: {
  ...
  bridge: {
    ...
    benefits: ['Strengthens glutes and legs', 'Opens chest and shoulders', 'Energises the body', 'Improves digestion'],
  ...
  suryaNamaskar: {
    ...
    benefits: ['Full body warm-up', 'Builds cardiovascular stamina', 'Energises every system', 'Links breath and movement'],
    reasoning: 'The most complete single sequence in yoga. Sun Salutations honour the sun\'s energy, building heat that awakens Kapha and channelling movement that satisfies Vata\'s need for flow.',
    voiceCues: {
      enter: 'Stand at the front of your mat with hands at heart centre. Take a deep breath to begin.',
  ...
  downwardDog: {
    ...
    benefits: ['Strengthens arms and legs', 'Stretches the whole back body', 'Calms the brain', 'Energises the body'],
    reasoning: 'A cornerstone of yoga that works as both an energiser and a resting pose. The inversion brings fresh blood to the brain while the long stretch releases tension stored in the back body.',
    voiceCues: {
