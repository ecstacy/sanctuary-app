...
export const ASANAS = {
  ...
  // ── Advanced & Stretch Tier ───────────────────────────────────────────
  // 15 entries. 7 are HYP-named directly (Ch. 1 verses 1.19 through
  // 1.32); 8 are modern advanced asanas commonly taught in
  // intermediate/advanced classes. All carry strong "work with a
  // teacher" framing in contraindications — these are not solo
  // self-discovery poses.

  // ── Swastikasana — HYP 1.19 ────────────────────────────────────────────
  // The Sanskrit "svastika" means "auspicious" — predates and is
  // unrelated to the 20th-century European appropriation. Used in
  // Indian iconography for millennia as a symbol of well-being.
  swastikasana: {
    id: 'swastikasana',
    sanskrit: 'Swastikasana',
    devanagari: 'स्वस्तिकासन',
    iast: 'svastikāsana',
    english: 'Auspicious Seat',
    aliases: ['Lucky Seat'],
    source: { text: 'HYP', verse: '1.19', note: 'First explicit asana named in HYP Ch. 1. The Sanskrit "svastika" means auspicious; the ancient symbol predates and is unrelated to its 20th-century European appropriation.' },
    category: 'seated',
    level: 'beginner',
    poseKey: 'swastikasana',
    icon: 'self_care',
    durationSeconds: 180,
    breathPattern: 'natural',
    breathCues: { notes: 'Natural breath. Like Sukhasana, this is a meditation seat — the breath finds its own rhythm.' },
    instructions: [
      'Sit on a folded blanket with the legs extended.',
      'Bend the right knee and tuck the right foot under the left thigh, close to the body.',
      'Bend the left knee and tuck the left foot between the right calf and right thigh.',
      'The legs form a tidy interlock — feet hidden, ankles symmetric.',
      'Rest the hands on the knees in jnana mudra (thumb and index touching).',
      'Lengthen the spine — crown reaches up, sit bones root down.',
      'Soften the jaw, soften the eyes.',
    ],
    voiceCues: {
      enter: 'Sit comfortably. Tuck the right foot under the left thigh, then the left foot between the right calf and thigh.',
      hold: 'Hands rest on the knees. Spine tall — crown of the head reaching toward the ceiling.',
      breathe: 'Breathe naturally. Each exhale releases another layer of tension.',
      exit: 'Gently unfold the legs and stretch them out in front of you.',
    },
    bodyParts: ['hips', 'knees', 'ankles', 'spine'],
    doshaAffinity: { vata: 1, pitta: 1, kapha: 0 },
    tags: ['seated', 'meditation', 'pre_meditation', 'pranayama_seat', 'vata_pacifying', 'pitta_pacifying', 'gentle', 'all_levels'],
    contraindications: [
      "Don't practice with knee or hip injury",
      "Avoid with severe sciatica",
      "Pregnant women in late pregnancy may find this uncomfortable — use Sukhasana on a high cushion",
    ],
    modifications: [
      "Sit on a folded blanket to elevate the hips and reduce knee strain",
      "Loosen the foot interlock — simple cross-legged Sukhasana is equally valid",
      "Place a small cushion under each knee if they hover above the floor",
    ],
    benefits: [
      "HYP's first named asana — the original meditation seat",
      "More structured than Sukhasana; less demanding than Padmasana",
      "Stable base for breath practice and silent sitting",
      "Gentle external rotation of the hips opens them over weeks of consistent practice",
    ],
    reasoning: "Swastikasana is the easier-than-lotus seated meditation pose that HYP opens its asana chapter with. The interlocked feet make the seat more stable than Sukhasana without demanding the deep hip rotation of Padmasana. Worth practicing if Sukhasana feels wobbly during longer sits.",
  },

  // ── Kurmasana — HYP 1.22 ────────────────────────────────────────────────
  // Kurma means tortoise. The pose mimics a tortoise withdrawing into
  // its shell — arms threaded under bent knees, torso folded forward.
  kurmasana: {
    id: 'kurmasana',
    sanskrit: 'Kurmasana',
    devanagari: 'कूर्मासन',
    ...
    aliases: ['Tortoise'],
    source: { text: 'HYP', verse: '1.22', note: 'Named in HYP Ch. 1 alongside the other foundational asanas. Kurma is also the name of Vishnu\'s second incarnation as a tortoise — the pose evokes a contemplative withdrawal.' },
    category: 'forward_fold',
    level: 'advanced',
    poseKey: 'kurmasana',
    icon: 'south',
    durationSeconds: 60,
    breathPattern: 'paced',
    breathCues: { enter: 'inhale', notes: 'Inhale to lengthen the spine before each deepening; exhale to fold further. Never force.' },
    instructions: [
      'Sit with the legs extended in a wide V.',
      'Bend the knees and place the feet flat on the floor about a leg-length apart, knees pointing up.',
      'Lean forward and thread each arm UNDER the corresponding bent knee.',
      'Walk the hands out to the sides under the thighs until the shoulders sit beneath the knees.',
      'Slowly straighten the legs as the torso lowers toward the floor.',
      'Rest the forehead or chin on the floor; the chest reaches toward the floor.',
      'Hold for several breaths. To exit: bend the knees, walk the hands back, sit up.',
    ],
    voiceCues: {
      enter: 'Sit with the legs wide. Bend the knees up. Thread each arm under its knee, walking the hands out to the sides.',
      hold: 'Straighten the legs slowly. Let the torso melt toward the floor. The forehead or chin rests on the floor.',
      breathe: 'Each exhale releases a touch deeper. Don\'t force — let gravity do the work.',
      exit: 'Bend the knees. Walk the hands back. Sit up slowly.',
    },
    bodyParts: ['hamstrings', 'hips', 'spine', 'shoulders', 'lower_back'],
    doshaAffinity: { vata: 1, pitta: 1, kapha: 0 },
    tags: ['forward_fold', 'advanced', 'hip_opener', 'hamstring_stretch', 'pitta_pacifying', 'evening', 'pre_meditation'],
    contraindications: [
      "ADVANCED pose — work with a teacher before attempting solo",
      "Don't practice with herniated disc, acute lower-back injury, or severe sciatica",
      "Skip with knee or hip injury",
      "Pregnant women shouldn't practice — the compression is unsafe",
      "Avoid after recent abdominal surgery",
    ],
    modifications: [
      "Practice Janu Sirsasana or Paschimottanasana first to build the hamstring length needed",
      "Use a folded blanket under the hips and a bolster on the legs for restorative variant",
      "Keep the knees bent — straightening them is the advanced expression",
      "Build duration gradually; start with 15-second holds",
    ],
    benefits: [
      "Deep release through the entire posterior chain (back, hamstrings, calves)",
      "Hip-opener through external rotation under load",
      "Calms the nervous system — the inward fold is contemplative",
      "Connects modern practitioners to one of HYP's foundational shapes",
    ],
    reasoning: "Kurmasana is one of those poses where the geometry teaches you what's possible only after years of patient hamstring work. For most users it's aspirational; for those with the mobility, it's one of the most quietly transformative shapes in the catalog — deep withdrawal as practice.",
  },

  // ── Kukkutasana — HYP 1.23 ──────────────────────────────────────────────
  // The "Cock Pose" — Lotus + arm balance, the hands threaded between
  // calf and thigh, the body lifted off the floor.
  kukkutasana: {
    id: 'kukkutasana',
    ...
    iast: 'kukkuṭāsana',
    english: 'Cock Pose',
    aliases: ['Rooster Pose'],
    source: { text: 'HYP', verse: '1.23', note: 'Named in HYP Ch. 1. Builds on Padmasana (HYP 1.44-49) — requires the full lotus AND arm-balance strength simultaneously.' },
    category: 'balance',
    level: 'advanced',
    poseKey: 'kukkutasana',
    ...
    durationSeconds: 30,
    breathPattern: 'natural',
    breathCues: { notes: 'Steady, even breath. Holding the breath under load is the most common error — keep it flowing.' },
    instructions: [
      'PREREQUISITE: established Padmasana (full lotus) without knee strain.',
      'Sit in Padmasana on a folded blanket.',
      'Thread the right arm between the right calf and right thigh, up to the elbow. Repeat with the left arm.',
      'Place the palms flat on the floor, fingers spread, shoulder-width apart.',
      'Press the palms firmly into the floor and lift the entire lotus base off the ground.',
      'Hold for several breaths with the body suspended in the air.',
      'Lower down slowly, unthread the arms, release Padmasana.',
    ],
    voiceCues: {
      enter: 'In Padmasana, thread the arms between calf and thigh on each side, palms flat to the floor.',
      hold: 'Press the palms strongly. Lift the lotus off the floor. Engage the core.',
      breathe: 'Steady breath. Don\'t hold the breath under the lift.',
      exit: 'Lower the lotus slowly. Unthread the arms. Release the legs.',
    },
    bodyParts: ['shoulders', 'arms', 'wrists', 'core', 'hips'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'advanced', 'arm_balance', 'core_strength', 'kapha_pacifying', 'feel_strong', 'progression'],
    contraindications: [
      "ADVANCED pose — practice with a teacher",
      "PREREQUISITE: full Padmasana that is comfortable for 5+ minutes",
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with knee or hip injury that limits Padmasana",
      "Pregnant women shouldn't practice",
      "Avoid with hernia or recent abdominal surgery",
    ],
    modifications: [
      "Build Padmasana first — months of preparation, not days",
      "Practice the arm-thread without lifting (Garbha Pindasana-like) before adding the lift",
      "Lift only briefly at first — 2-3 seconds, building over weeks",
    ],
    benefits: [
      "Builds extraordinary core, shoulder, and wrist strength",
      "Deep hip rotation maintained under arm-balance load",
      "HYP cites it as one of the asanas that 'destroys obesity and disease'",
      "Capstone integration of multiple asana skills",
    ],
    reasoning: "Kukkutasana is one of HYP's named asanas that the modern practitioner is least likely to ever reach — it requires Padmasana AND significant arm-balance strength simultaneously. Document it for completeness and tradition; very few users will progress to it.",
  },

  // ── Uttana Kurmasana — HYP 1.24 ─────────────────────────────────────────
  uttanaKurmasana: {
    id: 'uttanaKurmasana',
    sanskrit: 'Uttana Kurmasana',
    devanagari: 'उत्तान कूर्मासन',
    iast: 'uttāna kūrmāsana',
    english: 'Stretched Tortoise Pose',
    aliases: ['Upward Tortoise', 'Reclining Lotus'],
    source: { text: 'HYP', verse: '1.24', note: 'Named in HYP Ch. 1. The "stretched" or upward-facing tortoise — Kukkutasana reclined backward onto the back.' },
    category: 'balance',
    level: 'advanced',
    poseKey: 'uttanaKurmasana',
    icon: 'self_care',
    durationSeconds: 30,
    breathPattern: 'natural',
    breathCues: { notes: 'Slow breath. The shape is awkward — the breath is the anchor.' },
    instructions: [
      'PREREQUISITE: comfortable Kukkutasana.',
      'From Kukkutasana, slowly roll backward onto the upper back.',
      'Keep the arms threaded through the legs and grasp the ears or back of the head with the hands.',
      'The legs in lotus, now resting on the chest. The body curls inward like a tortoise on its back.',
      'Hold steady. Breathe slowly.',
      'To exit: gently roll back up to Kukkutasana, lower down, release Padmasana.',
    ],
    voiceCues: {
      enter: 'From Kukkutasana, slowly roll back onto the upper back with the arms still threaded through the legs.',
      hold: 'Grasp the ears or back of the head. The lotus rests on the chest. Curl inward.',
      breathe: 'Slow steady breath. The shape is contemplative withdrawal.',
      exit: 'Roll back up to seated. Unthread the arms. Release the legs.',
    },
    bodyParts: ['hips', 'spine', 'shoulders', 'core', 'neck'],
    doshaAffinity: { vata: 1, pitta: 0, kapha: 0 },
    tags: ['advanced', 'inversion', 'hip_opener', 'progression', 'vata_pacifying'],
    contraindications: [
      "ADVANCED pose — practice with a teacher",
      "PREREQUISITE: solid Kukkutasana practice",
      "Don't practice with neck, shoulder, or upper-back injury",
      "Skip with knee or hip injury",
      "Pregnant women shouldn't practice",
      "Avoid with vertigo or balance disorders",
    ],
    modifications: [
      "Build Kukkutasana first; this is its reclined extension",
      "Practice Garbha Pindasana (similar shape, easier entry) as a stepping stone",
      "Hold for 3-5 breaths only at first",
    ],
    benefits: [
      "Deep withdrawal — the body becomes a closed sphere",
      "Activates the bandhas (energetic locks) naturally through the compression",
      "Considered preparatory for pranayama in the classical sequence",
      "Closes the HYP 1.22-24 tortoise series",
    ],
    reasoning: "Like Kukkutasana, this is a documentary entry — few users will ever practice it. Including it preserves the full HYP Ch. 1 asana list and gives advanced practitioners a recognizable destination.",
  },

  // ── Dhanurasana variant: Mayurasana — HYP 1.32 ──────────────────────────
  // The Peacock Pose. Arm balance with the entire body parallel to
  // the floor, balanced on the elbows pressed into the abdomen.
  mayurasana: {
    id: 'mayurasana',
    sanskrit: 'Mayurasana',
    devanagari: 'मयूरासन',
    ...
    aliases: ['Peacock'],
    source: { text: 'HYP', verse: '1.32-33', note: 'Named in HYP Ch. 1. The text praises it as a digestive cure — capable of "digesting even kalakuta poison".' },
    category: 'balance',
    level: 'advanced',
    poseKey: 'mayurasana',
    icon: 'sports_gymnastics',
    durationSeconds: 15,
    breathPattern: 'natural',
    breathCues: { notes: 'Steady breath. Holding the breath under the lift is tempting and wrong — keep it flowing.' },
    instructions: [
      'Kneel on the mat, knees wide.',
      'Place the palms on the floor between the knees, fingers pointing BACK toward the body.',
      'Lower onto the forearms, pressing the elbows together into the lower abdomen (near the navel).',
      'Stretch the legs out behind you, balls of the feet on the floor.',
      'Shift the weight forward over the elbows; lift the feet off the floor.',
      'The body floats parallel to the floor, balanced entirely on the elbows pressed into the belly.',
      'Hold for several breaths. To exit: lower the feet, push back, sit up.',
    ],
    voiceCues: {
      enter: 'Kneel wide. Place the palms with fingers pointing back. Lower onto forearms with elbows together against the belly.',
      hold: 'Stretch the legs back. Shift the weight forward. Lift the feet — body floating parallel to the floor.',
      breathe: 'Steady breath. Engage the core to hold the float.',
      exit: 'Lower the feet down. Push back to seated. Rest the wrists by shaking them out.',
    },
    bodyParts: ['wrists', 'forearms', 'core', 'belly', 'shoulders'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'advanced', 'arm_balance', 'core_strength', 'digestion', 'kapha_pacifying'],
    contraindications: [
      "ADVANCED pose — practice with a teacher",
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with hernia, recent abdominal surgery, or severe digestive issues",
      "Pregnant women shouldn't practice",
      "Avoid with high blood pressure, heart disease, or eye conditions",
      "Skip immediately after eating — wait 3-4 hours",
    ],
    modifications: [
      "Build wrist strength with Chaturanga before attempting",
      "Practice the kneeling forearm position with feet still on the floor first",
      "Lift one leg at a time before lifting both",
      "Hold for 3-5 seconds initially; build duration over months",
    ],
    benefits: [
      "Builds extraordinary wrist, forearm, and core strength",
      "HYP claims significant digestive benefits — the abdominal pressure stimulates the gut",
      "Mental focus — the balance demands single-pointed attention",
      "One of the most distinctive shapes in the asana tradition",
    ],
    reasoning: "Peacock is famously hard to access — most practitioners need months of wrist conditioning before attempting. HYP's enthusiasm for its digestive effects is borne out by abdominal-pressure mechanics. Save for users who already have strong Chaturanga and Bakasana.",
  },

  // ── Simhasana — HYP 1.50-52 ─────────────────────────────────────────────
  // The Lion Pose. Seated with hands on knees, eyes wide, tongue out,
  // exhaling forcefully with a "haaa" sound — the lion's roar.
  simhasana: {
    id: 'simhasana',
    sanskrit: 'Simhasana',
    devanagari: 'सिंहासन',
    iast: 'siṃhāsana',
    english: 'Lion Pose',
    aliases: ['Lion', 'Lion Breath'],
    source: { text: 'HYP', verse: '1.50-52', note: 'Named in HYP Ch. 1. The text describes the wide-eyed gaze, the tongue extension, and the roaring exhale — explicitly called out as part of the practice.' },
    category: 'seated',
    level: 'beginner',
    poseKey: 'simhasana',
    ...
    durationSeconds: 60,
    breathPattern: 'paced',
    breathCues: { enter: 'inhale', notes: 'Deep inhale through the nose; explosive exhale through the open mouth with the tongue extended and a "haaaaa" sound. 5-8 rounds.' },
    instructions: [
      'Kneel on the mat with the knees together, sitting back on the heels (Vajrasana base). OR sit cross-legged.',
      'Place the palms on the knees, fingers spread wide.',
      'Inhale deeply through the nose.',
      'Open the mouth wide, extend the tongue as far down toward the chin as possible.',
      'Exhale forcefully through the open mouth, making a "HAAAAA" sound from the throat — the lion\'s roar.',
      'Widen the eyes — gaze up toward the third eye or down at the tip of the nose.',
      'Repeat 5-8 rounds. After the last round, close the eyes and rest.',
    ],
    voiceCues: {
      enter: 'Kneel on the mat, palms on the knees, fingers spread.',
      hold: 'Inhale through the nose. Open the mouth wide, stick the tongue out, exhale with a HAA sound. Widen the eyes.',
      breathe: 'Five rounds. Each roar releases more tension from the face and throat.',
      exit: 'After the last round, close the eyes and rest. Notice the warmth in the face.',
    },
    bodyParts: ['face', 'jaw', 'throat', 'tongue', 'eyes', 'diaphragm'],
    doshaAffinity: { vata: 0, pitta: -1, kapha: 1 },
    tags: ['seated', 'beginner_friendly', 'kapha_pacifying', 'release_tension', 'jaw_tension', 'voice_clarity', 'morning', 'energizing'],
    contraindications: [
      "Skip with severe jaw pain or recent dental surgery",
      "Avoid with active throat infection or laryngitis",
      "Pregnant women can practice without strain",
      "If you have tinnitus or hearing sensitivity, do the roar quietly",
    ],
    modifications: [
      "Roar quietly if practicing in a shared space",
      "Skip the tongue extension if it strains the tongue or jaw",
      "Practice cross-legged if the kneeling base is uncomfortable",
      "Do fewer rounds initially — 3 rounds builds the comfort to do more",
    ],
    benefits: [
      "Releases tension in the jaw, throat, and face — the chronic seat of social-stress holding",
      "HYP describes it as removing diseases of the throat",
      "Activates the platysma (neck muscle) and tongue — rarely-trained areas",
      "Surprisingly emotional — many users find it releases inhibition over time",
    ],
    reasoning: "Simhasana is the asana most people are too self-conscious to try in a public class — and that's exactly why it works. The combination of facial expression, tongue extension, and forceful exhale releases tension you didn't know was there. HYP explicitly names this practice; modern lineages sometimes drop the tongue extension to make it less awkward, but the original is most effective.",
  },

  // ── Bhadrasana — HYP 1.53-54 ────────────────────────────────────────────
  // The Auspicious Pose / Throne Pose / Gracious Pose. HYP describes
  // it as a meditation seat formed by joining the soles of the feet
  // and holding the toes — what modern teaching usually calls
  // Baddha Konasana. We document it under the HYP name.
  bhadrasana: {
    id: 'bhadrasana',
    sanskrit: 'Bhadrasana',
    devanagari: 'भद्रासन',
    iast: 'bhadrāsana',
    english: 'Gracious Pose',
    aliases: ['Throne Pose', 'Auspicious Pose', 'Cobbler Pose (modern interpretation)'],
    source: { text: 'HYP', verse: '1.53-54', note: 'Named in HYP Ch. 1. The text describes it as one of the four primary asanas for meditation. Some modern lineages conflate it with Baddha Konasana; we keep them separate to preserve HYP\'s distinct naming.' },
    category: 'seated',
    level: 'beginner',
    poseKey: 'bhadrasana',
    icon: 'self_care',
    durationSeconds: 180,
    breathPattern: 'natural',
    breathCues: { notes: 'Natural breath. Like the other HYP-named meditation seats, this is a sitting practice — the breath finds its own rhythm.' },
    instructions: [
      'Sit on a folded blanket with the legs extended.',
      'Bring the soles of the feet together and draw the heels close to the perineum.',
      'Grasp the feet firmly with both hands — fingers wrap around the outer edges.',
    ...
    voiceCues: {
      ...
      hold: 'Let the knees release toward the floor. Lengthen the spine — crown reaches up.',
      breathe: 'Natural breath. This is a meditation seat — let the body settle.',
      exit: 'Release the feet. Extend the legs and gently shake them out.',
    },
    bodyParts: ['hips', 'inner_thighs', 'groin', 'spine'],
    doshaAffinity: { vata: 1, pitta: 1, kapha: 0 },
    tags: ['seated', 'meditation', 'pre_meditation', 'pranayama_seat', 'hip_opener', 'vata_pacifying', 'pitta_pacifying', 'gentle'],
    contraindications: [
      "Don't practice with knee or hip injury",
      "Avoid with severe sciatica",
      "Pregnant women can practice with the feet further from the body (don't compress the abdomen)",
    ],
    modifications: [
      "Sit on a folded blanket to elevate the hips",
      "Place blocks under each knee for support — never force the knees down",
      "Move the feet further from the body for an easier hip stretch",
      "If holding the feet strains the lower back, rest the hands on the shins instead",
    ],
    benefits: [
      "HYP-named meditation seat — one of the foundational sitting practices",
      "Opens the hips through external rotation, accessible over time",
      "Stable and grounding — suitable for long holds",
      "Connects modern users to one of the original four meditation poses",
    ],
    reasoning: "Bhadrasana sits in the cluster of HYP-named meditation seats (Padmasana, Siddhasana, Swastikasana, Bhadrasana) — the four primary postures the text endorses. Modern teaching often uses Baddha Konasana interchangeably; we document them separately to preserve the source-text naming for users who want fidelity.",
  },

  // ── Kapotasana — King Pigeon (modern) ─────────────────────────────────
  kapotasana: {
    id: 'kapotasana',
    sanskrit: 'Kapotasana',
    devanagari: 'कपोतासन',
    ...
    aliases: ['Pigeon (full expression)'],
    source: { text: 'modern', note: 'Modern advanced backbend. Not in HYP Ch. 1. Often confused with Eka Pada Rajakapotasana; the full Kapotasana is a kneeling deep backbend, not the asymmetric hip-opener.' },
    category: 'backbend',
    level: 'advanced',
    poseKey: 'kapotasana',
    icon: 'gymnastics',
    durationSeconds: 30,
    breathPattern: 'paced',
    breathCues: { enter: 'inhale', notes: 'Inhale to lift the chest higher; exhale to settle into the shape. Don\'t hold the breath under the bend.' },
    instructions: [
      'PREREQUISITE: established Ustrasana (Camel Pose), Bhujangasana, and Setu Bandha.',
      'Kneel with the knees hip-width apart, thighs vertical.',
      'Inhale, lift the chest, and reach the arms overhead.',
      'Exhale and arch back, leading with the chest. Place the hands on the heels or further forward.',
      'Walk the hands toward the feet, eventually grasping the toes or pulling the head toward the feet.',
      'Drop the head back gently — eyes either looking at the feet or closed.',
      'To exit: walk the hands back, lift the chest, sit up slowly.',
    ],
    voiceCues: {
      enter: 'Kneel with the thighs vertical. Inhale and reach the arms overhead.',
      hold: 'Exhale and arch back. Walk the hands toward the heels, then toward the feet.',
      breathe: 'Steady breath. Each inhale opens the chest a little more.',
      exit: 'Walk the hands back. Inhale and lift the chest. Rest in Balasana.',
    },
    bodyParts: ['spine', 'hip_flexors', 'quadriceps', 'shoulders', 'chest'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['backbend', 'advanced', 'spine_extension', 'chest_opener', 'kapha_pacifying', 'progression'],
    contraindications: [
      "ADVANCED pose — work with a teacher before attempting",
      "Don't practice with severe lower-back injury, herniated disc, or sacroiliac instability",
      "Skip with neck injury or recent shoulder surgery",
      "Pregnant women shouldn't practice",
      "Avoid with high or low blood pressure, vertigo, or migraine",
    ],
    modifications: [
      "Build Ustrasana for months before attempting Kapotasana",
      "Use a wall — start with the hands on the wall, walk them down gradually over weeks",
      "Place blocks against the heels to give the hands a higher target",
      "Hold for only 5-10 seconds at first",
    ],
    benefits: [
      "Deepest backbend in the catalog — opens the entire front body",
      "Releases the hip flexors and quadriceps simultaneously",
      "Major chest and shoulder opening — counters years of forward posture",
      "Cardiovascular response — significant adrenaline release; many users feel euphoric afterward",
    ],
    reasoning: "Kapotasana is one of the most demanding backbends in modern practice. The combination of hip-flexor flexibility, spinal extension, and shoulder opening required is rare. Save for advanced practitioners with a regular Ustrasana and supported-bridge habit.",
  },
  ...
  bakasana: {
    ...
    english: 'Crow Pose',
    aliases: ['Crow'],
    source: { text: 'modern', note: 'Modern arm balance, named for sage Baka. Often confused with Kakasana (Crane); Bakasana has bent arms, Kakasana has straight arms.' },
    category: 'balance',
    level: 'intermediate',
    poseKey: 'bakasana',
    icon: 'gymnastics',
    durationSeconds: 20,
    breathPattern: 'natural',
    breathCues: { notes: 'Smooth, even breath. Holding the breath while balancing is the most common error — it tightens the body and makes the balance harder.' },
    instructions: [
      'Squat in Malasana (deep squat), feet hip-width apart, knees wide.',
      'Place the palms on the floor in front of the feet, shoulder-width apart, fingers spread wide.',
      'Bend the elbows slightly outward (chaturanga-style — elbows track over the wrists, not flared wide).',
    ...
    voiceCues: {
      ...
      hold: 'Knees press against the back of the upper arms. Shift weight forward. Lift the feet.',
      breathe: 'Gaze forward, not down. Breath steady. The gaze is what makes the balance possible.',
      exit: 'Lower the feet to the floor. Stand up slowly. Shake out the wrists.',
    },
    bodyParts: ['wrists', 'forearms', 'shoulders', 'core', 'hip_flexors'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'arm_balance', 'intermediate', 'core_strength', 'wrist_strength', 'kapha_pacifying', 'feel_strong', 'concentration'],
    contraindications: [
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with carpal tunnel syndrome",
      "Pregnant women shouldn't practice past the first trimester",
      "Avoid with high blood pressure",
      "Skip if you can't yet hold a strong plank for 30 seconds",
    ],
    modifications: [
      "Practice with a block under the forehead so falling forward is safe",
      "Start with one foot at a time — get comfortable lifting one before both",
      "Place a folded blanket in front of the hands in case of a forward fall",
      "Build wrist and core strength first: plank, side plank, chaturanga",
    ],
    benefits: [
      "Most accessible arm balance — the entry point to the wider arm-balance family",
      "Builds wrist, forearm, and shoulder strength dramatically",
      "Demands single-pointed focus — the gaze IS the practice",
      "Confidence-builder once landed — many users find their first arm balance transformative",
    ],
    reasoning: "Crow is THE gateway arm balance. Most users can land it within 2-4 weeks of focused practice if they have the core and wrist strength. The trick is gaze direction — looking forward (not down) is what makes the balance findable. Use a block under the forehead during the learning curve.",
  },
  ...
  kakasana: {
    ...
    english: 'Crane Pose',
    aliases: ['Crane'],
    source: { text: 'modern', note: 'Modern arm balance — the straight-armed sibling of Bakasana (Crow). The deeper version with arms fully extended.' },
    category: 'balance',
    level: 'advanced',
    poseKey: 'kakasana',
    icon: 'gymnastics',
    durationSeconds: 15,
    breathPattern: 'natural',
    breathCues: { notes: 'Steady breath. The straight-arm balance is more demanding — keep the breath flowing.' },
    instructions: [
      'PREREQUISITE: stable Bakasana (Crow) for 15+ seconds.',
      'Set up exactly as in Bakasana: deep squat, palms on the floor, knees against the upper arms.',
      'Place the knees HIGHER on the arms — closer to the armpits.',
      'Press the floor away and STRAIGHTEN the arms completely.',
      'The hips lift higher, the body more vertical than in Crow.',
      'Hold steady. Gaze forward. The shape is more elegant, less compressed than Crow.',
      'To exit: bend the arms back to Crow, lower the feet, stand up.',
    ],
    voiceCues: {
      enter: 'Set up as Crow but place the knees higher on the arms, near the armpits.',
      hold: 'Press the floor away and straighten the arms. The hips lift; the body lengthens upward.',
      breathe: 'Steady. The straight arms make it more elegant but more demanding.',
      exit: 'Bend the arms back to Crow. Lower the feet. Shake out the wrists.',
    },
    bodyParts: ['wrists', 'shoulders', 'core', 'hip_flexors', 'triceps'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'arm_balance', 'advanced', 'core_strength', 'wrist_strength', 'kapha_pacifying', 'progression'],
    contraindications: [
      "ADVANCED — practice with a teacher",
      "PREREQUISITE: solid Bakasana before progressing",
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with carpal tunnel syndrome",
      "Pregnant women shouldn't practice",
    ],
    modifications: [
      "Master Bakasana first — Crane is its straight-armed progression",
      "Hold for 3-5 seconds initially",
      "Practice the lift from a higher base (e.g., a block under each foot) to reduce wrist demand",
    ],
    benefits: [
      "Deeper wrist and shoulder strength than Bakasana",
      "More elegant arm-balance shape — useful for movement-based flows",
      "Preparation for Astavakrasana and other lifted arm balances",
    ],
    reasoning: "Crane is the natural progression from Crow once Crow is held effortlessly for 30+ seconds. The straight arms shift the load from the upper arms to the wrists and shoulders, demanding more strength but rewarding with a more sustainable shape.",
  },
  ...
  chaturangaDandasana: {
    ...
    devanagari: 'चतुरङ्ग दण्डासन',
    iast: 'caturaṅga daṇḍāsana',
    english: 'Four-Limbed Staff Pose',
    aliases: ['Low Plank', 'Yogi Push-Up'],
    source: { text: 'modern', note: 'Modern asana, central to vinyasa flow practice. Not in HYP Ch. 1.' },
    category: 'balance',
    level: 'intermediate',
    poseKey: 'chaturangaDandasana',
    icon: 'fitness_center',
    durationSeconds: 15,
    breathPattern: 'paced',
    breathCues: { enter: 'exhale', notes: 'Exhale to lower from plank to chaturanga. The hold is on the exhale.' },
    instructions: [
      'Begin in plank pose, shoulders over wrists, body in one line.',
      'Shift the weight slightly forward — shoulders move past the wrists.',
      'Exhale and bend the elbows straight back, hugging them close to the ribs.',
      'Lower until the upper arms are parallel to the floor (90-degree bend at the elbow).',
      'The body stays in one straight line — shoulders, hips, and heels aligned.',
      'Hold steady. Hug the elbows in — don\'t let them flare out.',
      'To exit: inhale to Upward Dog or lower fully to the floor.',
    ],
    voiceCues: {
      enter: 'From plank, shift the weight forward. Shoulders move past the wrists.',
      hold: 'Exhale and bend the elbows straight back, hugging them to the ribs. Upper arms parallel to the floor.',
      breathe: 'Steady. Body in one line. Elbows in.',
      exit: 'Inhale, press up to Upward Dog, OR lower fully to the floor and rest.',
    },
    bodyParts: ['shoulders', 'triceps', 'core', 'wrists'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'strength', 'intermediate', 'core_strength', 'shoulder_strength', 'wrist_strength', 'kapha_pacifying', 'vinyasa'],
    contraindications: [
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with rotator cuff issues — Chaturanga is the #1 cause of shoulder injury in modern yoga",
      "Pregnant women shouldn't practice past the first trimester",
      "Avoid with carpal tunnel syndrome",
    ],
    modifications: [
      "Lower to the knees first — Half Chaturanga is a legitimate full-time practice",
      "Stay in plank instead and skip the lower-down",
      "Lower only to the elbows-at-90 position, NEVER deeper (the shoulders can\'t safely go below the elbows)",
      "Use a yoga block under the chest as a safety floor — lower until the chest touches",
    ],
    benefits: [
      "Builds the upper-body strength needed for arm balances and inversions",
      "Engages the core in a way few other poses do",
      "Connective tissue throughout the shoulders adapts and strengthens",
      "Foundation of vinyasa transitions — once dialed in, the whole flow practice opens up",
    ],
    reasoning: "Chaturanga is the most-injured pose in modern yoga because it's done dozens of times per class without proper form. The fix is simple: drop to the knees, OR don't lower below 90 degrees. Half Chaturanga is a legitimate full-time variant; there's no shame in it.",
  },

  // ── Vasishthasana — Side Plank ─────────────────────────────────────────
  vasishthasana: {
    id: 'vasishthasana',
    sanskrit: 'Vasishthasana',
    devanagari: 'वसिष्ठासन',
    iast: 'vasiṣṭhāsana',
    english: 'Side Plank',
    aliases: ['Side Plank', 'Sage Vasishtha\'s Pose'],
    source: { text: 'modern', note: 'Modern asana, named for the sage Vasishtha — one of the seven sages of Hindu tradition. Not in HYP Ch. 1.' },
    category: 'balance',
    level: 'intermediate',
    poseKey: 'vasishthasana',
    icon: 'gymnastics',
    durationSeconds: 30,
    breathPattern: 'natural',
    breathCues: { notes: 'Steady breath. The whole side-body works; keep the breath even to avoid clenching.' },
    instructions: [
      'From plank, shift the weight onto the right hand.',
      'Roll onto the outer edge of the right foot, stacking the left foot on top of the right.',
      'Stack the right shoulder over the right wrist. Keep the right arm straight.',
      'Extend the left arm straight up toward the ceiling. The body forms one straight line.',
      'Gaze either straight ahead or up at the top hand.',
      'Hold steady. The hips lift — don\'t let them sag.',
      'Switch sides. To exit: lower back to plank.',
    ],
    voiceCues: {
      enter: 'From plank, roll onto the outer edge of the right foot, stacking the left foot on top.',
      hold: 'Right shoulder stacks over right wrist. Lift the left arm straight up. Body in one line.',
      breathe: 'Steady breath. Lift through the hips — don\'t let them sag.',
      exit: 'Lower back to plank. Switch sides.',
    },
    bodyParts: ['core', 'obliques', 'shoulders', 'wrists', 'glutes'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'strength', 'intermediate', 'core_strength', 'oblique_strength', 'shoulder_strength', 'kapha_pacifying'],
    contraindications: [
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with carpal tunnel syndrome",
      "Pregnant women in the second/third trimester should modify (knee-down variant)",
      "Avoid with severe neck pain — the gaze adds load",
    ],
    modifications: [
      "Drop the bottom knee to the floor for a knee-down variant",
      "Press the bottom forearm down instead of the hand for less wrist load",
      "Use a wall behind you to feel the alignment",
      "Place the top foot on the floor in front of the bottom foot (kickstand) for stability",
    ],
    benefits: [
      "Strengthens the obliques — the often-neglected side-body core",
      "Trains shoulder stability under load on one arm",
      "Decent wrist conditioning for arm-balance progressions",
      "Asymmetry training — one side at a time",
    ],
    reasoning: "Side Plank is the side-body's counterpart to Plank — equally fundamental but more demanding. The hip-sag is the universal mistake; lifting through the hips is what makes the pose work. Use the knee-down variant freely; the strength still builds.",
  },
  ...
  astavakrasana: {
    ...
    devanagari: 'अष्टावक्रासन',
    iast: 'aṣṭāvakrāsana',
    english: 'Eight-Angle Pose',
    aliases: ['Eight-Angle'],
    source: { text: 'modern', note: 'Modern advanced arm balance, named for the sage Astavakra. Not in HYP Ch. 1.' },
    category: 'balance',
    level: 'advanced',
    poseKey: 'astavakrasana',
    icon: 'gymnastics',
    durationSeconds: 15,
    breathPattern: 'natural',
    breathCues: { notes: 'Steady breath. Advanced arm balances are mental as much as physical — the breath is the key to staying calm.' },
    instructions: [
      'PREREQUISITE: stable Bakasana, strong Chaturanga, open hamstrings.',
      'Sit with the legs extended. Bend the right knee and hook the right thigh over the right shoulder.',
      'Cross the left ankle over the right ankle, locking the legs together at the ankles, with the body weight in the right hand and the legs hanging from the right shoulder.',
      'Place both palms on the floor beside the hips.',
      'Lean forward and lift the body off the floor.',
      'Bend the elbows like Chaturanga and extend the locked legs out to the right side.',
      'Hold steady. To exit: bring the legs back to center, lower the body, release the legs.',
    ],
    voiceCues: {
      enter: 'Hook the right thigh over the right shoulder. Cross the left ankle over the right, locking the legs.',
      hold: 'Palms on the floor. Lean forward. Lift the body, extend the legs out to the side.',
      breathe: 'Steady. The breath is the anchor — don\'t hold it.',
      exit: 'Bring the legs back to center. Lower the body. Unwind the legs.',
    },
    bodyParts: ['shoulders', 'arms', 'core', 'hip_flexors', 'hamstrings'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['balance', 'advanced', 'arm_balance', 'core_strength', 'kapha_pacifying', 'progression'],
    contraindications: [
      "ADVANCED — practice with a teacher",
      "PREREQUISITE: stable Bakasana and strong Chaturanga",
      "Don't practice with wrist, elbow, or shoulder injury",
      "Skip with hamstring tear or severe sciatica",
      "Pregnant women shouldn't practice",
      "Avoid with high blood pressure",
    ...
    modifications: [
      "Build the foundation: Bakasana, Chaturanga, Compass Pose first",
      "Use a block under each palm to give the lift more clearance",
      "Hold for 3-5 seconds initially",
    ],
    benefits: [
      "Combines arm balance, hip rotation, and asymmetric load in one shape",
      "Builds the strength + flexibility integration that defines advanced practice",
      "Mental focus — the asymmetric lift demands single-pointed attention",
    ],
    reasoning: "Eight-Angle is one of the most distinctive shapes in the advanced repertoire. The hip-over-shoulder hook plus side-lift is unusual — few poses train this geometry. Save for users with multiple years of dedicated practice.",
  },
  ...
  pasasana: {
    ...
    english: 'Noose Pose',
    aliases: ['Noose'],
    source: { text: 'modern', note: 'Modern advanced twist. "Pasha" means noose — the arms wrap around the legs like a binding rope. Not in HYP Ch. 1.' },
    category: 'twist',
    level: 'advanced',
    poseKey: 'pasasana',
    icon: 'autorenew',
    durationSeconds: 30,
    breathPattern: 'paced',
    breathCues: { enter: 'inhale', notes: 'Inhale to lengthen; exhale to deepen the twist. Don\'t force on the breath out.' },
    instructions: [
      'Squat in Malasana with the heels on the floor (or on a folded blanket if they don\'t reach).',
      'Inhale and turn the torso to the right.',
      'Exhale and wrap the left arm around the OUTSIDE of the right thigh and across the front of the body.',
      'Reach the right arm behind the back and clasp the left wrist or fingers — forming the noose.',
      'Lengthen the spine. Turn the gaze over the right shoulder.',
      'Hold steady. To exit: release the bind, rotate back to center, switch sides.',
    ],
    voiceCues: {
      enter: 'Squat low with the heels down. Inhale tall.',
      hold: 'Exhale and rotate right. Wrap the left arm outside the right thigh. Reach the right hand behind the back to clasp.',
      breathe: 'Each exhale deepens the twist. The bind is intense — don\'t force.',
      exit: 'Release the bind. Rotate back to center. Switch sides.',
    },
    bodyParts: ['spine', 'shoulders', 'hips', 'ankles', 'lower_back'],
    doshaAffinity: { vata: 0, pitta: 1, kapha: 1 },
    tags: ['twist', 'advanced', 'rotation', 'hip_opener', 'shoulder_opener', 'pitta_pacifying', 'kapha_pacifying'],
    contraindications: [
      "ADVANCED — practice with a teacher",
      "Don't practice with herniated disc, SI joint instability, or severe lower-back injury",
      "Skip with severe ankle injury — the deep squat demands ankle flexibility",
      "Pregnant women shouldn't practice closed twists",
      "Avoid after recent abdominal, hip, or back surgery",
    ],
    modifications: [
      "Use a folded blanket under the heels if they don't reach the floor",
      "Hook the elbow on the outside of the knee instead of wrapping the arm — partial Marichyasana C-style",
      "Use a strap between the hands if the fingers don't meet behind the back",
      "Practice Marichyasana A through C as preparation",
    ],
    benefits: [
      "Deepest seated/squatted twist in the catalog",
      "Combines hip opening (deep squat) with rotational mobility",
      "Demands ankle flexibility — useful for users with chronically tight calves",
    ],
    reasoning: "Noose Pose is the advanced twist — built on the foundation of Marichyasana and Ardha Matsyendrasana. The deep squat base makes it inaccessible to users with tight ankles or hips; document it for completeness in the advanced repertoire.",
  },

  // ── Adho Mukha Vrksasana — Handstand ───────────────────────────────────
  adhoMukhaVrksasana: {
    id: 'adhoMukhaVrksasana',
    sanskrit: 'Adho Mukha Vrksasana',
    devanagari: 'अधो मुख वृक्षासन',
    iast: 'adho mukha vṛkṣāsana',
    english: 'Handstand',
    aliases: ['Downward-Facing Tree Pose'],
    source: { text: 'modern', note: 'Modern advanced inversion. Codified in 20th-century practice; not in HYP Ch. 1.' },
    category: 'inversion',
    level: 'advanced',
    poseKey: 'adhoMukhaVrksasana',
    icon: 'accessibility_new',
    durationSeconds: 15,
    breathPattern: 'natural',
    breathCues: { notes: 'Smooth, even breath. Holding the breath under the inversion spikes blood pressure — keep it flowing.' },
    instructions: [
      'PREREQUISITE: strong Down Dog, plank, and shoulder stability. Practice at a wall.',
      'Place the palms on the floor about 6 inches from a wall, shoulder-width apart.',
      'Walk the feet toward the hands until the hips stack over the shoulders.',
      'One leg kicks up; the other follows. Heels touch the wall lightly.',
      'Stack: wrists → shoulders → hips → heels in one vertical line.',
      'Engage the core, press through the palms, gaze between the hands.',
      'To exit: lower one leg at a time, slowly back to Down Dog.',
    ],
    voiceCues: {
      enter: 'Hands flat on the floor near a wall. Walk the feet in toward the hands.',
      hold: 'Kick one leg up, then the other. Heels touch the wall lightly. Press the palms into the floor.',
      breathe: 'Steady breath. Engage the core. The whole body is one straight line.',
      exit: 'Lower one leg at a time. Rest in Down Dog. Then Child\'s Pose.',
    },
    bodyParts: ['shoulders', 'wrists', 'core', 'spine'],
    doshaAffinity: { vata: 0, pitta: 0, kapha: 1 },
    tags: ['inversion', 'advanced', 'balance', 'core_strength', 'shoulder_strength', 'kapha_pacifying'],
    contraindications: [
      "ADVANCED — practice with a teacher",
      "Don't practice with wrist, elbow, shoulder, or neck injury",
      "Skip with carpal tunnel syndrome",
      "Pregnant women shouldn't practice",
      "Avoid with high blood pressure, glaucoma, retinal detachment, or vertigo",
      "Skip during menstruation if heavy inversions feel uncomfortable",
    ],
    modifications: [
      "Practice at a wall — never solo in the middle of the room before the inversion is stable",
      "Hold for 3-5 seconds at first, building over weeks",
      "Build the prerequisites: Pincha Mayurasana (forearm stand), strong handstand at the wall",
      "Use a spotter for the first many attempts",
    ],
    benefits: [
      "Most demanding inversion in the catalog — full-body strength and balance",
      "Builds wrist, shoulder, and core conditioning unlike any other pose",
      "The big inversion: cardiovascular, lymphatic, and confidence effects",
      "Capstone pose for a strong asana practice",
    ],
    reasoning: "Handstand is the asana that most students aspire to and most never achieve solo. The wall practice can become a stable medium-term home — many practitioners enjoy a 15-second wall handstand without ever attempting free balance. Both are legitimate.",
  },
