...
export const INGREDIENTS = {
  ...
  // ── Batch 7 (draft, 2026-07-28) — see docs/diet-review-batch-7.md ──────────
  // Classical items (attested in the CS Sutrasthana 27 food catalogue) are
  // 'high' confidence; German/Western and regional-only staples are 'modern'
  // and 'medium', with the specific doubt flagged in the source note. Every
  // row is reviewStatus 'draft' — invisible until a human checks it.
  ...
  amaranth: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'cooling', vipaka: 'sweet', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: -1 },
    whyFavor: 'Light and cooling — a gluten-free grain that suits Pitta and reduces Kapha.',
    whyAvoid: 'Light and dry, so it can unsettle Vata unless well-oiled.',
    source: { text: 'modern', note: 'A fasting/regional grain, not a classical monograph. Derived: light, dry, cooling.' },
  ...
  buckwheat: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: 1, kapha: -1 },
    whyFavor: 'Light, dry and warming — a good winter grain for reducing Kapha.',
    whyAvoid: 'Dry and heating, so it unsettles Vata and adds to Pitta; poor in summer.',
    source: { text: 'modern', note: 'Fasting/regional grain, absent from the classical corpus. Derived: light, dry, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  foxtailMillet: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'heating', vipaka: 'sweet', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: 1, kapha: -1 },
    whyFavor: 'Light, dry and warming — reduces Kapha, like the other small millets.',
    whyAvoid: 'Drying and heating, so it unsettles Vata and adds to Pitta.',
    source: { text: 'modern', note: 'Kangu appears in later/regional tradition rather than a full classical monograph. Derived: light, dry, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  sago: {
    id: 'sago', name: 'Sago (tapioca pearls)', aliases: ['sabudana', 'sabudhana', 'tapioca', 'sago'],
    category: 'grain', rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 },
    whyFavor: 'Bland, cooling and easy — a soft, grounding starch for Vata and hot Pitta; a common fasting food.',
    whyAvoid: 'Heavy and starchy, so it adds to Kapha and gives little else.',
    source: { text: 'modern', note: 'A New World starch, absent from the classical corpus. Derived: sweet, heavy, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  whiteBread: {
    id: 'whiteBread', name: 'White bread', aliases: ['maida bread', 'weißbrot', 'refined bread', 'toast'],
    category: 'grain', rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy'],
    doshaEffect: { vata: 0, pitta: 0, kapha: 1 },
    whyFavor: 'Soft and filling, and gentler on Vata than dry crackers.',
    whyAvoid: 'Refined and heavy with little to it — sluggish, and it clearly adds to Kapha.',
    source: { text: 'modern', note: 'Refined-wheat product, absent from the classical corpus. Derived from wheat: sweet, heavy; refining removes the roughage so it reads heavier for Kapha.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  soybean: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'heating', vipaka: 'pungent', guna: ['heavy', 'oily'],
    doshaEffect: { vata: 1, pitta: 0, kapha: 1 }, allergens: ['soy'],
    whyFavor: 'Rich and building — one of the more protein-dense pulses.',
    whyAvoid: 'Heavy, oily and gas-forming — slow to digest and hard for Vata; heavy for Kapha.',
    preparation: 'Best well-fermented or as tofu; the whole bean is heavy and needs long, spiced cooking.',
    balancedBy: ['asafoetida', 'gingerFresh', 'cumin'],
    source: { text: 'modern', note: 'Absent from the classical pulse list. Derived: heavy, oily, gas-forming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  horseGram: {
    id: 'horseGram', name: 'Horse gram', sanskrit: 'Kulattha', devanagari: 'कुलत्थ',
    aliases: ['kulthi', 'hurali', 'kollu', 'kulattha'], category: 'legume',
    rasa: ['astringent'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 0, pitta: 1, kapha: -1 },
    whyFavor: 'Light, dry and warming — Charaka names Kulattha as scraping and Kapha-reducing; traditionally used for stones.',
    whyAvoid: 'Heating and astringent, so it aggravates Pitta and can inflame the blood.',
    cautions: ['acid_reflux'],
  ...
  mothBean: {
    ...
    category: 'legume', rasa: ['sweet', 'astringent'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: 1, kapha: -1 },
    whyFavor: 'Light and warming — one of the more digestible pulses, especially sprouted.',
    whyAvoid: 'Dry and mildly heating, so it can unsettle Vata and add to Pitta.',
    balancedBy: ['asafoetida', 'cumin'],
    source: { text: 'modern', note: 'Regional pulse, thin classical coverage. Derived: light, dry, mildly warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  blackBean: {
    ...
    doshaEffect: { vata: 1, pitta: 0, kapha: 1 },
    whyAvoid: 'Heavy and dry like the other New World beans — gas-forming for Vata, heavy for Kapha.',
    preparation: 'Soak overnight and cook very thoroughly with warming spices.',
    balancedBy: ['asafoetida', 'cumin', 'gingerFresh'],
    source: { text: 'modern', note: 'New World bean, absent from the classical corpus. Derived: heavy, dry, gas-forming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },

  // Vegetables
  pumpkin: {
    id: 'pumpkin', name: 'Pumpkin', aliases: ['kaddu', 'red pumpkin', 'kürbis', 'sitaphal vegetable'],
    category: 'vegetable', rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'moist'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 },
    whyFavor: 'Sweet, soft and cooling — grounding for Vata and soothing for Pitta.',
    whyAvoid: 'Heavy and moist, so it adds to Kapha.',
    source: { text: 'modern', note: 'Ripe red pumpkin sits in regional rather than core classical tradition (distinct from Kushmanda/ash gourd). Derived: sweet, heavy, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  drumstick: {
  ...
  pointedGourd: {
    ...
    rasa: ['bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: -1, pitta: -1, kapha: -1 },
    whyFavor: 'Light and easy — Charaka praises Patola as wholesome and tridoshic, kindling appetite without heaviness.',
    whyAvoid: 'Very light and drying in excess for an already-depleted Vata.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  ivyGourd: {
    ...
    whyAvoid: 'Light and drying, so use it moist for Vata.',
    source: { text: 'modern', note: 'Bimbi is named classically but its food profile is largely derived here: light, cooling, astringent.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  elephantYam: {
    id: 'elephantYam', name: 'Elephant-foot yam', sanskrit: 'Surana', devanagari: 'सूरण',
    aliases: ['suran', 'jimikand', 'ol', 'elephant yam'], category: 'vegetable',
    rasa: ['pungent', 'astringent'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: 0, pitta: 1, kapha: -1 },
  ...
  turnip: {
    ...
    category: 'vegetable', rasa: ['pungent', 'sweet'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: 1, kapha: -1 },
    whyFavor: 'Light and warming — a winter root that reduces Kapha.',
    whyAvoid: 'Pungent and drying, so it can unsettle Vata and add to Pitta; gas-forming raw.',
    source: { text: 'modern', note: 'Thin classical coverage. Derived: light, pungent, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  fennelBulb: {
    id: 'fennelBulb', name: 'Fennel (bulb)', aliases: ['saunf bulb', 'fenchel', 'florence fennel'],
    category: 'vegetable', rasa: ['sweet', 'pungent'], virya: 'cooling', vipaka: 'sweet', guna: ['light'],
    doshaEffect: { vata: -1, pitta: -1, kapha: -1 },
    whyFavor: 'Sweet, light and gently cooling — a rare tridoshic vegetable that also settles digestion, echoing fennel seed.',
    whyAvoid: 'Very light, so pair with oil for a depleted Vata.',
    source: { text: 'modern', note: 'The bulb vegetable is derived from the classical profile of fennel seed (Mishreya): sweet, cooling, digestive.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  celery: {
    id: 'celery', name: 'Celery', aliases: ['ajmoda stalk', 'sellerie', 'celery stalk'],
    category: 'vegetable', rasa: ['astringent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: -1 },
    whyFavor: 'Light, dry and mildly warming — reduces Kapha and is gently diuretic.',
    whyAvoid: 'Light and drying, so it can unsettle Vata.',
    source: { text: 'modern', note: 'Stalk profile derived from the classical seed (Ajmoda). Derived: light, dry, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  brusselsSprouts: {
    id: 'brusselsSprouts', name: 'Brussels sprouts', aliases: ['rosenkohl', 'sprouts'],
    category: 'vegetable', rasa: ['astringent', 'sweet'], virya: 'cooling', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: -1 },
    whyFavor: 'Light and cooling — like the rest of the cabbage family, it suits Pitta and reduces Kapha.',
    whyAvoid: 'Dry and gas-forming, so it clearly unsettles Vata.',
    preparation: 'Cook well with warming spices; raw or under-cooked it is very gas-forming.',
    balancedBy: ['asafoetida', 'cumin', 'blackPepper'],
    source: { text: 'modern', note: 'A brassica, absent from the classical corpus. Derived like cabbage: light, dry, cooling, gas-forming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  artichoke: {
    id: 'artichoke', name: 'Artichoke', aliases: ['artischocke', 'globe artichoke'],
    category: 'vegetable', rasa: ['bitter', 'astringent'], virya: 'cooling', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: -1 },
    ...
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived: bitter, light, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  mustardGreens: {
    id: 'mustardGreens', name: 'Mustard greens', aliases: ['sarson ka saag', 'sarson', 'senfblätter'],
    category: 'vegetable', rasa: ['pungent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: 0, pitta: 1, kapha: -1 },
    whyFavor: 'Pungent, light and warming — a winter leafy that strongly reduces Kapha.',
    whyAvoid: 'Sharp and heating, so it aggravates Pitta.',
    preparation: 'Traditionally slow-cooked with ghee, which softens the sharpness and grounds it for Vata.',
    source: { text: 'modern', note: 'Leaf profile derived from mustard (Sarshapa): pungent, sharp, heating.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  jamun: {
    ...
    rasa: ['astringent', 'sour', 'sweet'], virya: 'cooling', vipaka: 'pungent', guna: ['light', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: -1 },
  ...
  jackfruit: {
    ...
    rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 },
    whyFavor: 'Sweet, heavy and cooling — Charaka names Panasa among the strengthening fruits; grounding for Vata and Pitta.',
    whyAvoid: 'Very heavy and slow to digest, so it adds to Kapha and can sit heavily.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  raisins: {
  ...
  muskmelon: {
    ...
    category: 'fruit', rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'moist'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 }, bestSeason: ['summer'],
    whyFavor: 'Sweet, watery and cooling — a hydrating summer fruit that soothes Pitta.',
    whyAvoid: 'Heavy and watery, so it adds to Kapha; best eaten alone, not with other foods.',
    source: { text: 'modern', note: 'Like watermelon, a regional melon with thin classical coverage. Derived: sweet, heavy, cooling, watery.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  sweetLime: {
    id: 'sweetLime', name: 'Sweet lime (mosambi)', aliases: ['mosambi', 'musambi', 'sweet lime', 'sathukudi'],
    category: 'fruit', rasa: ['sweet', 'sour'], virya: 'cooling', vipaka: 'sweet', guna: ['light'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 0 },
    whyFavor: 'Mild, sweet and cooling — gentler than orange, soothing for Vata and Pitta.',
    whyAvoid: 'Its light sourness can add slightly to Pitta if taken in excess.',
    source: { text: 'modern', note: 'A citrus with thin classical coverage. Derived: mostly sweet, mildly sour, cooling, light.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  plum: {
    id: 'plum', name: 'Plum', aliases: ['aloo bukhara', 'pflaume', 'plum'], category: 'fruit',
    rasa: ['sweet', 'sour'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'moist'],
    doshaEffect: { vata: -1, pitta: 0, kapha: 1 },
    whyFavor: 'Sweet-sour, juicy and cooling — grounding for Vata and gently laxative.',
    whyAvoid: 'Its sourness can nudge Pitta, and the sweetness adds to Kapha.',
    source: { text: 'modern', note: 'Thin classical coverage. Derived: sweet-sour, moist, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  apricot: {
    id: 'apricot', name: 'Apricot', aliases: ['khubani', 'aprikose', 'apricot', 'khumani'], category: 'fruit',
    rasa: ['sweet', 'sour'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'moist'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 },
    whyFavor: 'Sweet, warming and building — grounding and strengthening for Vata.',
    whyAvoid: 'Sweet-sour and warming, so it adds to Pitta and Kapha.',
    source: { text: 'modern', note: 'Thin classical coverage. Derived: sweet-sour, warming (ripe stone fruit).' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  cherry: {
    id: 'cherry', name: 'Cherry', aliases: ['kirsche', 'cherries', 'cherry'], category: 'fruit',
    rasa: ['sweet', 'sour'], virya: 'heating', vipaka: 'sweet', guna: ['light', 'moist'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 0 },
    whyFavor: 'Sweet-sour and warming — settling for Vata.',
    whyAvoid: 'Sourness and warmth add to Pitta.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived: sweet-sour, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  kiwi: {
    ...
    whyAvoid: 'Distinctly sour, so it adds to Pitta.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived: sweet-sour, light, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  blueberry: {
    ...
    whyAvoid: 'Astringent and light, so in excess it can unsettle Vata.',
    source: { text: 'modern', note: 'A New World berry, absent from the classical corpus. Derived: sweet-astringent, light, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  custardApple: {
    ...
    source: { text: 'modern', note: 'Regional fruit with thin classical coverage. Derived: sweet, heavy, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  lotusSeed: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'cooling', vipaka: 'sweet', guna: ['light', 'dry'],
    doshaEffect: { vata: 0, pitta: -1, kapha: -1 },
    whyFavor: 'Sweet, light and cooling — a rare light nut/seed that suits Pitta and Kapha; roasted, it is an easy snack.',
    whyAvoid: 'Light and dry, so pair with a little ghee for Vata.',
    source: { text: 'modern', note: 'The lotus (Padma) is classical, its seed food-profile largely derived: sweet, light, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  pumpkinSeed: {
    id: 'pumpkinSeed', name: 'Pumpkin seeds', aliases: ['kaddu ke beej', 'kürbiskerne', 'pepitas'],
    category: 'nut_seed', rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 },
    whyFavor: 'Oily, warming and building — grounding for Vata.',
    whyAvoid: 'Oily and heating, so it adds to Pitta and Kapha.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived like other oily seeds: heavy, oily, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  chiaSeed: {
    id: 'chiaSeed', name: 'Chia seeds', aliases: ['chia', 'chiasamen', 'tukmaria substitute'],
    category: 'nut_seed', rasa: ['sweet', 'astringent'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: 0, pitta: -1, kapha: 0 },
    whyFavor: 'Cooling and soothing once soaked and gelled — settling for Pitta and gently grounding.',
    whyAvoid: 'Dry and light before soaking, so it can unsettle Vata; always soak first.',
    preparation: 'Soak until gelled; eaten dry they are drying and hard to digest.',
    source: { text: 'modern', note: 'A New World seed, absent from the classical corpus. Derived: cooling, oily once soaked; drying dry.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  hazelnut: {
    ...
    category: 'nut_seed', rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 }, allergens: ['nuts'],
    whyFavor: 'Oily, warming and building — grounding and strengthening for Vata.',
    whyAvoid: 'Oily and heating, so it adds to Pitta and Kapha.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived like other tree nuts: heavy, oily, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  chestnut: {
    id: 'chestnut', name: 'Chestnut', aliases: ['maroni', 'esskastanie', 'singhara relative', 'chestnuts'],
    category: 'nut_seed', rasa: ['sweet', 'astringent'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'dry'],
    doshaEffect: { vata: 1, pitta: -1, kapha: 0 },
    whyFavor: 'Sweet, starchy and cooling — a low-fat nut that is gentler on Pitta.',
    whyAvoid: 'Heavy and dry, so it can be gas-forming and unsettle Vata.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived: sweet, starchy, heavy, drier and cooler than oily nuts.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  longPepper: {
    ...
    rasa: ['pungent'], virya: 'heating', vipaka: 'sweet', guna: ['light', 'oily', 'sharp'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    ...
    whyAvoid: 'Heating and sharp, so it aggravates Pitta; classically cautioned against long, heavy use.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  holyBasil: {
    ...
    rasa: ['pungent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: 0, pitta: 1, kapha: -1 },
    whyFavor: 'Pungent, light and warming — Charaka-tradition Surasa clears Kapha and the chest and kindles digestion.',
    whyAvoid: 'Sharp and heating, so it aggravates Pitta.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  rockSalt: {
    ...
    rasa: ['salty'], virya: 'heating', vipaka: 'sweet', guna: ['light'],
    doshaEffect: { vata: -1, pitta: 0, kapha: 0 },
    whyFavor: 'Charaka names Saindhava the best of salts — light and the least heating, so it settles Vata without much aggravating Pitta or Kapha.',
    whyAvoid: 'Still salty, so large amounts add to Pitta and cause fluid retention like any salt.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  dillSeed: {
    id: 'dillSeed', name: 'Dill seed', sanskrit: 'Shatapushpa', devanagari: 'शतपुष्पा',
    aliases: ['sowa', 'suva', 'dill', 'dillsamen'], category: 'spice',
    rasa: ['pungent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    whyFavor: 'Pungent and warming — a digestive and carminative that settles Vata and clears Kapha.',
    whyAvoid: 'Heating and sharp, so it aggravates Pitta.',
    source: { text: 'modern', note: 'Shatapushpa is classical but often identified as fennel; the dill identification and food profile are derived: pungent, light, warming, carminative.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  starAnise: {
    id: 'starAnise', name: 'Star anise', aliases: ['chakra phool', 'badian', 'sternanis', 'star anise'],
    category: 'spice', rasa: ['sweet', 'pungent'], virya: 'heating', vipaka: 'sweet', guna: ['light', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    whyFavor: 'Sweet-pungent and warming — a carminative that settles Vata and clears Kapha.',
    whyAvoid: 'Heating, so it adds to Pitta.',
    source: { text: 'modern', note: 'Absent from the classical corpus. Derived like anise/fennel-adjacent aromatics: sweet-pungent, warming, carminative.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  mace: {
    id: 'mace', name: 'Mace', sanskrit: 'Jatipatri', devanagari: 'जातिपत्री',
    aliases: ['javitri', 'jaepatri', 'macis', 'mace'], category: 'spice',
    rasa: ['pungent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'oily', 'sharp'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    whyFavor: 'Aromatic, pungent and warming — the aril of nutmeg, it kindles digestion and settles Vata.',
    whyAvoid: 'Heating and sharp, so it aggravates Pitta; use sparingly.',
    source: { text: 'modern', note: 'Companion to nutmeg (Jatiphala); profile derived from the same source: pungent, warming, aromatic.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  nigella: {
    id: 'nigella', name: 'Nigella seed', aliases: ['kalonji', 'kalaunji', 'black cumin', 'schwarzkümmel'],
    category: 'spice', rasa: ['pungent', 'bitter'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    whyFavor: 'Pungent, light and warming — a digestive that settles Vata and strongly clears Kapha.',
    whyAvoid: 'Heating and sharp, so it aggravates Pitta.',
    source: { text: 'modern', note: 'Thin classical coverage under this identity. Derived: pungent, light, warming, digestive.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  rosemary: {
    ...
    source: { text: 'modern', note: 'A Mediterranean herb, absent from the classical corpus. Derived: pungent-bitter, light, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  thyme: {
    id: 'thyme', name: 'Thyme', aliases: ['thymian', 'thyme', 'ajwain-scented herb'],
    category: 'spice', rasa: ['pungent'], virya: 'heating', vipaka: 'pungent', guna: ['light', 'dry', 'sharp'],
    doshaEffect: { vata: -1, pitta: 1, kapha: -1 },
    whyFavor: 'Pungent, light and warming — a digestive and expectorant that settles Vata and clears Kapha.',
    whyAvoid: 'Heating and sharp, so it aggravates Pitta.',
    source: { text: 'modern', note: 'A Mediterranean herb, absent from the classical corpus. Derived (thymol is akin to ajwain): pungent, warming, sharp.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  poppySeed: {
    ...
    rasa: ['sweet', 'astringent'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 0, kapha: 1 },
    whyFavor: 'Sweet, oily and grounding — settling and mildly sedative, good for Vata; a natural thickener.',
    whyAvoid: 'Heavy and oily, so it adds to Kapha; also binding/constipating in excess.',
    source: { text: 'modern', note: 'Regional culinary seed with thin classical food coverage. Derived: sweet, heavy, oily, grounding.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  peanutOil: {
    ...
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 }, allergens: ['peanuts'],
    ...
    source: { text: 'modern', note: 'Peanut is a New World crop; oil profile derived: heavy, oily, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  almondOil: {
    ...
    category: 'oil', rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 }, allergens: ['nuts'],
    whyFavor: 'Rich, sweet and warming — nourishing and grounding for Vata, and gentle enough to finish dishes.',
    whyAvoid: 'Heavy and heating, so it adds to Pitta and Kapha.',
    source: { text: 'modern', note: 'Oil profile derived from almond (Vatama): sweet, heavy, oily, warming.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  rockCandy: {
    ...
    rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 },
    whyFavor: 'Sweet and cooling — Charaka regards Sharkara as the most cooling and least heavy of sugars, soothing for Vata and Pitta.',
    whyAvoid: 'Still a sugar, so it adds to Kapha and, in excess, to fat and lethargy.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  mapleSyrup: {
    ...
    source: { text: 'modern', note: 'A North American sweetener, absent from the classical corpus. Derived like other sugars: sweet, heavy, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  coconutWater: {
    ...
    rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['light'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 0 }, bestSeason: ['summer'],
    whyFavor: 'Sweet, light and cooling — Charaka-tradition tender-coconut water is hydrating and settles Vata and Pitta without heaviness.',
  ...
  sugarcaneJuice: {
    ...
    whyAvoid: 'Sweet and heavy, so it adds to Kapha; spoils and ferments quickly once pressed.',
    source: { text: 'CS', verse: 'Sutrasthana 27' },
    reviewStatus: 'draft', confidence: 'high',
  },
  cocoa: {
    id: 'cocoa', name: 'Cocoa', aliases: ['cacao', 'kakao', 'dark chocolate', 'chocolate'],
    ...
    source: { text: 'modern', note: 'A New World stimulant, absent from the classical corpus. Derived: bitter-astringent, light, dry, heating, stimulating.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  cream: {
    ...
    rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: -1, kapha: 1 }, allergens: ['dairy'],
    whyFavor: 'Rich, sweet and cooling — deeply nourishing and grounding for Vata, soothing for Pitta.',
    whyAvoid: 'Very heavy and oily, so it strongly adds to Kapha and is slow to digest.',
    source: { text: 'modern', note: 'The cream/skin of milk (Santanika) is named classically; profile derived: sweet, heavy, oily, cooling.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  khoa: {
    id: 'khoa', name: 'Khoa (reduced milk)', aliases: ['mawa', 'khoya', 'milchmasse'], category: 'dairy',
    rasa: ['sweet'], virya: 'cooling', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 0, kapha: 1 }, allergens: ['dairy'],
    whyFavor: 'Concentrated, sweet and building — very grounding for Vata; the base of many milk sweets.',
    whyAvoid: 'Extremely heavy and slow, so it strongly adds to Kapha; heavier than fresh milk.',
    source: { text: 'modern', note: 'Reduced-milk solid; profile derived from milk, concentrated: sweet, very heavy, oily.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
  ...
  fishFreshwater: {
    ...
    rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 }, allergens: ['fish'],
  ...
  goatMeat: {
    ...
    rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy'],
    doshaEffect: { vata: -1, pitta: 0, kapha: 0 },
    whyFavor: 'Building yet balanced — Charaka singles out Aja (goat) meat as wholesome, not overly aggravating to any dosha.',
  ...
  prawn: {
    ...
    rasa: ['sweet'], virya: 'heating', vipaka: 'sweet', guna: ['heavy', 'oily'],
    doshaEffect: { vata: -1, pitta: 1, kapha: 1 }, allergens: ['shellfish'],
    ...
    source: { text: 'modern', note: 'Shellfish sit at the margins of the classical corpus. Derived: sweet, heavy, oily, heating.' },
    reviewStatus: 'draft', confidence: 'medium',
  },
}
