...
//
//  ✅ Reviewed & live 2026-08-24 — human-reviewed with the founder and flipped to
//  `reviewStatus: 'reviewed'` (review sheet: docs/diet-review-modern-batch-6.md).
//  Property-derived (source.text 'modern', confidence 'medium'). Sign convention:
...
export const MODERN_DRAFT_INGREDIENTS_6 = {
  ...
  bhatura: {
    ...
    allergens: ['gluten'], cautions: ['deep_fried'],
