...
const RECOMMENDATIONS = [
  {
    ...
    practices: [
      ...
      { poseId: 'suptaMatsyendrasana', title: 'Supine Twist', subtitle: 'Supta Matsyendrasana', duration: '4 min', level: 'Beginner', icon: 'rotate_right', description: 'A reclined twist that releases the lower back and decompresses the spine with gravity\'s help.' },
      { poseId: 'balasana', title: 'Child\'s Pose', subtitle: 'Balasana', duration: '3 min', level: 'Beginner', icon: 'spa', description: 'A resting pose that gently stretches the lower back and hips while calming the nervous system.' },
      { poseId: 'setuBandhaSarvangasana', title: 'Bridge Pose', subtitle: 'Setu Bandhasana', duration: '3 min', level: 'Intermediate', icon: 'landscape', description: 'Strengthens the glutes and core to support the lower back, while gently opening the chest.' },
      { poseId: 'ekaPadaRajakapotasana', title: 'Pigeon Pose', subtitle: 'Eka Pada Rajakapotasana', duration: '5 min', level: 'Intermediate', icon: 'self_care', description: 'A deep hip opener that releases tension that often refers pain to the lower back.' },
    ],
  ...
  },
  {
    ...
    practices: [
      ...
      { poseId: 'uttanasana', title: 'Forward Fold', subtitle: 'Uttanasana', duration: '3 min', level: 'Beginner', icon: 'south', description: 'Inverted blood flow to the head relieves pressure and calms the nervous system.' },
      { poseId: 'legsUpTheWall', title: 'Legs Up the Wall', subtitle: 'Viparita Karani', duration: '7 min', level: 'Beginner', icon: 'vertical_align_top', description: 'A restorative inversion that reduces blood pressure and soothes the mind.' },
      { poseId: 'garudasana', title: 'Seated Eagle Arms', subtitle: 'Garudasana Arms', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Deep stretch between the shoulder blades that releases upper back and neck tension.' },
    ],
  ...
  },
  {
    ...
    practices: [
      { poseId: 'tadasana', title: 'Grounding Mountain', subtitle: 'Tadasana', duration: '2 min', level: 'Beginner', icon: 'landscape', description: 'Stand rooted and feel gravity. A simple but powerful practice of present-moment awareness.' },
      { poseId: 'balasana', title: 'Child\'s Pose', subtitle: 'Balasana', duration: '3 min', level: 'Beginner', icon: 'spa', description: 'Folding inward activates the parasympathetic nervous system and signals safety.' },
      { poseId: 'virabhadrasanaII', title: 'Warrior II', subtitle: 'Virabhadrasana II', duration: '4 min', level: 'Beginner', icon: 'fitness_center', description: 'A strong, grounded posture that builds confidence and channels anxious energy.' },
      { title: 'Yoga Nidra', route: '/nidra', subtitle: 'Yogic Sleep', duration: '15 min', level: 'Beginner', icon: 'bedtime', description: 'Guided deep relaxation that activates the body\'s natural calm response. Profoundly effective.' },
    ],
  ...
  },
  {
    ...
    practices: [
      ...
      { poseId: 'garudasana', title: 'Eagle Arms', subtitle: 'Garudasana Arms', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Wrapping the arms creates a deep stretch across the entire upper back and shoulders.' },
  ...
  },
  {
    ...
    practices: [
      { poseId: 'legsUpTheWall', title: 'Legs Up the Wall', subtitle: 'Viparita Karani', duration: '7 min', level: 'Beginner', icon: 'vertical_align_top', description: 'Drains lymph, calms the heart rate, and signals the body that it\'s safe to rest.' },
      { poseId: 'suptaBaddhaKonasana', title: 'Reclined Butterfly', subtitle: 'Supta Baddha Konasana', duration: '5 min', level: 'Beginner', icon: 'spa', description: 'Opens the hips and chest, releasing the day\'s accumulated tension.' },
      { poseId: 'paschimottanasana', title: 'Forward Fold', subtitle: 'Paschimottanasana', duration: '3 min', level: 'Beginner', icon: 'south', description: 'A calming seated fold that compresses the belly and activates the vagus nerve.' },
      { title: 'Yoga Nidra', route: '/nidra', subtitle: 'Yogic Sleep', duration: '20 min', level: 'Beginner', icon: 'bedtime', description: 'Guided body-scan meditation that takes you to the edge of sleep. Many drift off during practice.' },
    ],
  ...
  },
  {
    ...
    practices: [
      { poseId: 'ardhaMatsyendrasana', title: 'Seated Twist', subtitle: 'Ardha Matsyendrasana', duration: '4 min', level: 'Beginner', icon: 'rotate_right', description: 'Wringing out the abdominal organs to stimulate digestion and release trapped gas.' },
      { poseId: 'apanasana', title: 'Wind-Relieving Pose', subtitle: 'Pawanmuktasana', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Exactly what it sounds like. Compresses the ascending and descending colon.' },
      { poseId: 'cardiacWarmup', title: 'Cat-Cow', subtitle: 'Marjaryasana-Bitilasana', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Rhythmic abdominal movement that massages the internal organs and improves motility.' },
      { poseId: 'jatharaParivartanasana', title: 'Supine Twist', subtitle: 'Jathara Parivartanasana', duration: '4 min', level: 'Beginner', icon: 'rotate_right', description: 'A gentle reclined twist that stimulates the liver, spleen, and intestines.' },
    ],
  ...
  },
  {
    ...
    practices: [
      { poseId: 'ekaPadaRajakapotasana', title: 'Pigeon Pose', subtitle: 'Eka Pada Rajakapotasana', duration: '5 min', level: 'Intermediate', icon: 'self_care', description: 'The king of hip openers. Releases the piriformis and deep external rotators.' },
      ...
      { poseId: 'suptaBaddhaKonasana', title: 'Reclined Butterfly', subtitle: 'Supta Baddha Konasana', duration: '5 min', level: 'Beginner', icon: 'spa', description: 'A gentle, gravity-assisted inner hip opener. Let the knees fall open and breathe.' },
      ...
      { poseId: 'anjaneyasana', title: 'Low Lunge', subtitle: 'Anjaneyasana', duration: '4 min', level: 'Beginner', icon: 'self_care', description: 'Stretches the hip flexors and psoas — the muscle most punished by sitting.' },
    ],
  ...
  },
  {
    ...
    practices: [
      ...
      { poseId: 'garudasana', title: 'Eagle Pose', subtitle: 'Garudasana', duration: '3 min', level: 'Intermediate', icon: 'self_care', description: 'Requires intense concentration to balance — trains single-pointed focus.' },
      { poseId: 'vrksasana', title: 'Tree Pose', subtitle: 'Vrksasana', duration: '3 min', level: 'Beginner', icon: 'park', description: 'A balancing pose that forces the mind to become still and present.' },
  ...
  },
  {
    ...
    practices: [
      { poseId: 'utkatasana', title: 'Chair Pose', subtitle: 'Utkatasana (Modified)', duration: '3 min', level: 'Beginner', icon: 'event_seat', description: 'A gentle squat against the wall that strengthens the quadriceps to support the knee.' },
      { poseId: 'virabhadrasanaI', title: 'Warrior I', subtitle: 'Virabhadrasana I', duration: '4 min', level: 'Beginner', icon: 'fitness_center', description: 'Strengthens the muscles around the knee joint with controlled alignment.' },
      { poseId: 'suptaPadangusthasana', title: 'Reclined Leg Stretch', subtitle: 'Supta Padangusthasana', duration: '4 min', level: 'Beginner', icon: 'self_care', description: 'Stretches the hamstrings without any load on the knee joint.' },
  ...
  },
  {
    ...
    practices: [
      { poseId: 'suryaNamaskarA', title: 'Sun Salutation', subtitle: 'Surya Namaskar', duration: '12 min', level: 'Beginner', icon: 'wb_sunny', description: '5 rounds of the classic energizing flow. Each round builds heat and vitality.' },
      { poseId: 'virabhadrasanaIII', title: 'Warrior III', subtitle: 'Virabhadrasana III', duration: '3 min', level: 'Intermediate', icon: 'fitness_center', description: 'A powerful balancing pose that demands full-body engagement and presence.' },
      ...
      { poseId: 'utkatasana', title: 'Chair Pose', subtitle: 'Utkatasana', duration: '2 min', level: 'Beginner', icon: 'event_seat', description: 'Burns through Kapha lethargy and activates the legs, core, and willpower.' },
    ],
  ...
  },
  {
    ...
    practices: [
      { poseId: 'bhujangasana', title: 'Cobra Pose', subtitle: 'Bhujangasana', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Strengthens the spinal erectors and opens the chest to counteract forward rounding.' },
      { poseId: 'salabhasana', title: 'Locust Pose', subtitle: 'Salabhasana', duration: '3 min', level: 'Beginner', icon: 'self_care', description: 'Strengthens the entire posterior chain — the muscles that hold you upright.' },
  ...
  },
  {
    ...
    practices: [
      { poseId: 'suptaBaddhaKonasana', title: 'Reclined Butterfly', subtitle: 'Supta Baddha Konasana', duration: '5 min', level: 'Beginner', icon: 'spa', description: 'Opens the pelvis and encourages blood flow. Use a bolster under the back for extra comfort.' },
      { poseId: 'balasana', title: 'Child\'s Pose', subtitle: 'Balasana (Wide Knee)', duration: '4 min', level: 'Beginner', icon: 'spa', description: 'A wide-knee variation that creates space for the belly and gently stretches the lower back.' },
      { poseId: 'suptaMatsyendrasana', title: 'Supine Twist', subtitle: 'Supta Matsyendrasana', duration: '4 min', level: 'Beginner', icon: 'rotate_right', description: 'A gentle twist that eases lower back pain and reduces bloating.' },
      { poseId: 'legsUpTheWall', title: 'Legs Up the Wall', subtitle: 'Viparita Karani', duration: '7 min', level: 'Beginner', icon: 'vertical_align_top', description: 'Reduces pelvic congestion and soothes the nervous system. Deeply restorative.' },
    ],
