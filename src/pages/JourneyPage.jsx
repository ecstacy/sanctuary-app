  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-body pb-20">
      ...
      <div className="px-6 pt-3 pb-2 flex items-center gap-3">
        <button onClick={() => navigate(-1)} className="w-11 h-11 rounded-full bg-surface-container-high flex items-center justify-center" aria-label={t('journey.goBack')}>
          ...
          <div className="bg-surface-container-low rounded-2xl p-5 stagger-5">
            ...
            <div className="flex flex-col gap-2">
              {[...stats.sessions].reverse().slice(0, 10).map(session => {
                ...
                return (
                  <div key={session.id} className="flex items-center gap-3 bg-surface-container rounded-xl px-4 py-3">
