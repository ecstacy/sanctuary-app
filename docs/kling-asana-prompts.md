...
### 23. Prasarita Padottanasana — Wide-Legged Forward Fold  ✅ DONE
...
### 24. Anjaneyasana — Low Lunge  ✅ DONE
...
### 25. Utthita Hasta Padangusthasana — Hand-to-Big-Toe  ✅ DONE
...
### 27. Natarajasana — Dancer's Pose  ✅ DONE
...
### 28. Parivrtta Trikonasana — Revolved Triangle  ✅ DONE
...
### 29. Padmasana — Lotus Pose  *(hold-only, no entry)*  ✅ DONE
...
### 30. Siddhasana — Accomplished Pose  *(hold-only, no entry)*  ✅ DONE
...
### 31. Vajrasana — Thunderbolt Pose  *(hold-only, no entry)*  ✅ DONE
...
### 32. Ardha Padmasana — Half Lotus  *(hold-only, no entry)*  ✅ DONE
...
### 33. Baddha Konasana — Bound Angle Pose  *(hold-only, no entry)*  ✅ DONE
...
### 34. Upavishta Konasana — Wide-Angle Seated Forward Bend  ✅ DONE
...
### 35. Janu Sirsasana — Head-to-Knee Pose  ✅ DONE
...
### 36. Gomukhasana — Cow Face Pose  ✅ DONE
...
### 37. Marichyasana A — Marichi's Pose A  ✅ DONE
...
### 38. Marichyasana C — Marichi's Pose C  *(seated twist)*  ✅ DONE
...
### 39. Bharadvajasana — Bharadvaja's Twist  ✅ DONE
...
### 40. Virasana — Hero Pose  *(hold-only, no entry)*  ✅ DONE
...
### 41. Malasana — Garland Pose / Yogic Squat  ✅ DONE
...
### 42. Mandukasana — Frog Pose  *(hold-only, no entry)*  ✅ DONE
...
### 43. Supta Baddha Konasana — Reclined Bound Angle  *(hold-only, no entry)*  ✅ DONE
...
### 44. Supta Padangusthasana — Reclined Hand-to-Big-Toe  ✅ DONE
...
### 45. Apanasana — Knees-to-Chest  *(hold-only, no entry)*  ✅ DONE
...
```
Supported Headstand (Salamba Sirsasana I) — forearm base, NOT a palms-flat tripod headstand. Forearms on the mat with the fingers interlaced into a cup; the back of the head nests into the interlaced hands and the crown presses lightly into the floor. Elbows roughly shoulder-width apart. Body forms one long vertical line: forearms/elbows-shoulders-hips-legs all stacked. Both legs extended straight up toward the ceiling, ankles together, toes pointing up. MOST OF THE WEIGHT in the forearms (about 80-90%); only light pressure through the crown. Body inverted but stable, calm, controlled. Engaged core visible. Side view, full body in frame, open studio floor (no wall).
```

**🎬 Kling motion prompt:**

```
Over 5 seconds, starting from a kneeling position, she: interlaces the fingers and places the forearms on the mat, nests the crown of the head into the cupped interlaced hands, lifts the hips up like Down Dog, walks the feet in toward the elbows, then draws the bent knees toward the chest and slowly extends both legs straight up overhead, ankles together — arriving at the inverted peak around second 4. She holds steady for 1 breath. Then she slowly lowers the legs back down to kneeling with control. Static camera.
```
